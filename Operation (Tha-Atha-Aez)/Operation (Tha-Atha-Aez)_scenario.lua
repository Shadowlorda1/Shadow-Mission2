...
ScenarioInfo = {
    ...
    preview = '',
    size = {1024, 2048},
    map = '/maps/Operation (Tha-Atha-Aez)/Operation (Tha-Atha-Aez).scmap',
    save = '/maps/Operation (Tha-Atha-Aez)/Operation (Tha-Atha-Aez)_save.lua',
    script = '/maps/Operation (Tha-Atha-Aez)/Operation (Tha-Atha-Aez)_script.lua',
    ...
    norushoffsetX_ARMY_5 = 120.000000,
    norushoffsetY_ARMY_5 = 120.000000,
    norushoffsetX_ARMY_6 = 120.000000,
    norushoffsetY_ARMY_6 = 120.000000,
    norushoffsetX_ARMY_7 = 120.000000,
    norushoffsetY_ARMY_7 = 120.000000,
    norushoffsetX_ARMY_8 = 120.000000,
    norushoffsetY_ARMY_8 = 120.000000,
    Configurations = {
        ['standard'] = {
            teams = {
                { name = 'FFA', armies = {'Player','SeraphimAlly','UEF','Aeon','ARMY_5','ARMY_6','ARMY_7','ARMY_8',} },
            },
            customprops = {
            },
        },
